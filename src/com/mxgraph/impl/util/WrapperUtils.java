...
import com.mxgraph.impl.model.MxCell;
import com.mxgraph.impl.model.MxGraphModel;
import com.mxgraph.impl.view.MxEventSource.MxIEventListener;
...
public class WrapperUtils {
	...
	private static IJavaScriptWrapper createWrapper(String className) {
		...
		// GWT compiler cannot dynamically create the class with GWT.create(classLiteral) method. Hence the if-else.
				if (className.equalsIgnoreCase( getSimpleName(MxCell.class))) {
		...
		//			wrapper = GWT.create(mxConnectionConstraint.class);
				} else if (className.equalsIgnoreCase(getSimpleName(MxGraphModel.class))) {
	...
	public static native <C extends IJavaScriptWrapper> List<C> wrapList(JavaScriptObject list) /*-{
		...
		if (list != null) {
			...
			for ( var i = 0; i < list.length; i++) {
				...
				var instance = @com.mxgraph.impl.util.WrapperUtils::wrap(Lcom/google/gwt/core/client/JavaScriptObject;)(list[i]);
	...
	public static native JavaScriptObject unwrapList(List<? extends IJavaScriptWrapper> list) /*-{
		...
		if (list != null) {
			...
			for ( var i = 0; i < list.@java.util.List::size()(); i++) {
				...
				jsList[i] = elem.@com.mxgraph.jso.IJavaScriptWrapper::getJso()();
			}
		}
	...
	public static native <K extends Object, V extends IJavaScriptWrapper> JavaScriptObject unwrapMap(Map<K, V> map) /*-{
		...
		while (keySetIterator.@java.util.Iterator::hasNext()()) {
			...
			jso = map.@java.util.Map::get(Ljava/lang/Object;)(key).@com.mxgraph.jso.IJavaScriptWrapper::getJso()();
			mapJS[key] = jso;
		}
	...
	public static native <K extends Object, V extends IJavaScriptWrapper> Map<K, V> wrapMap(JavaScriptObject map) /*-{
		...
		for ( var key in map) {
			...
			//create an instance of wrapper
			var instanceJ = @com.mxgraph.impl.util.WrapperUtils::wrap(Lcom/google/gwt/core/client/JavaScriptObject;)(map[key]);
			//add it to the map
	...
	public static native JavaScriptObject wrapCallbackInterface(MxIEventListener<?> listener) /*-{
		var callbackFunction = function(sender, eventObject) {
			//wraps event object
			var eventObjectJ = @com.mxgraph.impl.util.WrapperUtils::wrap(Lcom/google/gwt/core/client/JavaScriptObject;)(eventObject)
			//wraps the sender object
			var senderJ = @com.mxgraph.impl.util.WrapperUtils::wrap(Lcom/google/gwt/core/client/JavaScriptObject;)(sender);
			//Calls mxIEventListener.invoke with wrapped event object
			listener.@com.mxgraph.impl.view.MxEventSource.MxIEventListener::invoke(Ljava/lang/Object;Lcom/mxgraph/impl/view/MxEventObject;)(senderJ,eventObjectJ);
		};
	...
	//			var sourceJ = @com.mxgraph.impl.util.WrapperUtils::wrap(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
	//			var targetJ = @com.mxgraph.impl.util.WrapperUtils::wrap(Lcom/google/gwt/core/client/JavaScriptObject;)(target);
	//			var cellJ = factoryMethod.@com.mxgraph.impl.handler.MxConnectionHandler.MxIFactoryMethod::invoke(Lcom/mxgraph/gwt/client/model/mxCell;Lcom/mxgraph/gwt/client/model/mxCell;Ljava/lang/String;)
	//				(sourceJ, targetJ, style);
	//			return @com.mxgraph.impl.util.WrapperUtils::unwrap(Lcom/mxgraph/jso/IJavaScriptWrapper;)(cellJ);
	//
	//		};
	//
